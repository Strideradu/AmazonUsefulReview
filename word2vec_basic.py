...
save_path = "C:/Users/User/Documents/GitHub/UsefulReview/word2vec_model/"
...
"""
def load_json_raw_data(chunk_path, chunk_num, review_text):

    chunk_path = chunk_path + str(chunk_num) + '.json'
    with open(chunk_path, 'r') as json_chunk_file:
        for lines in json_chunk_file:
            ...
            review_text.extend(str(line_jsonify['reviewText']).lower().split())
...
vocabulary = []
for i in range(26):
    load_json_raw_data("C:/Users/User/Documents/GitHub/UsefulReview/json_raw/Electronics_5_chunk_", i, vocabulary)
